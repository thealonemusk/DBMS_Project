...
cout<<"\t|       *FOUNDATION:         |\n";
cout<<"\t|____________________________|\n";
cout<<"\n\t\tZIT foundation was established by ZIT Society(R) in 2023,Jalandhar\n";
cout<<"\n\t\tThe ZIEIT is being managed by 10 Board of Directors consisting of eminent educationist and Industrialist.\n";
cout<<"\n";
cout<<"\n";
cout<<"\t ____________________________\n";
cout<<"\t|      *ACCREDITATION:       |\n";
...
cout<<"\t|____________________________|\n";
cout<<"\n\t\tAs required by the AICTE,the following is the mandatory disclosure provided by ZIEIT,Jalandhar.\n";
cout<<"\n";
cout<<"\n";
cout<<"\n\t\t************************************    T H A N K     Y O U   ************************************\n";
return;
